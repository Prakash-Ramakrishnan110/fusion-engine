  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="flex-1 pt-24 sm:pt-28 pb-16">
        {/* Page Header */}
        <section className="py-12 bg-secondary/20 border-b border-border/40 mb-12">
          <div className="container mx-auto px-4 max-w-5xl text-center">
            ...
            >
              <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-semibold uppercase tracking-wider mb-4">
              ...
              <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
                Ready to transform your idea into reality? Fill out the form below or chat with us. 
                We guarantee a response within <span className="text-foreground font-medium">2 hours</span>.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        {/* FAQ Section */}
        <section className="container mx-auto px-4 max-w-4xl mt-20 pt-16 border-t border-border/40">
          <motion.div
