  ...
  return (
    <section ref={containerRef} className="relative pt-28 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        <motion.div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-gradient-to-r from-purple-500/10 to-pink-500/10 blur-[120px]"
          style={{
            scale: 1 + Math.cos(mousePosition.y * Math.PI) * 0.2,
            rotate: (mousePosition.y - 0.5) * -20
          }}
        />
        <motion.div
          className="absolute inset-0"
          style={{
            background: `radial-gradient(circle at ${mousePosition.x * 100}% ${mousePosition.y * 100}%, rgba(168, 85, 247, 0.12) 0%, transparent 60%)`
          }}
        />
      </div>
